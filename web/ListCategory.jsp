                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> ${cate.id} </td>
                                                        <td>
                                                            <img src="images/nike_air_jordan_1.png" alt="image" />
                                                            <span class="pl-2">${cate.name}</span>
                                                        </td>
                                                        
                                                        
                                                        <td>
                                                            <div class="badge badge-outline-danger"><a href="#" onclick="doDelete('${cate.id}')">Delete</td></div>
                                                        </td>
                                                    </tr>
                                                    </c:forEach>
                                                </tbody>
