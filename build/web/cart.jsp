<%-- 
    Document   : cart
    Created on : Mar 7, 2022, 9:54:50 PM
    Author     : admin
--%>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td class="product-thumbnail">
                      <img src="images/${c.value.shoes.image}" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">${c.value.shoes.name}</h2>
                    </td>
                    <td>$${c.value.shoes.price}</td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
                        
                        <input type="text" class="form-control text-center" value="${c.value.quantity}" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
                    ...
                    <td>
                        <form action="process" method="post">
                            <input type="hidden" name="id" value="${c.value.shoes.id}"/>
            ...
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row mb-5">
                  ...
                  <div class="col-md-6 text-right">
                      <strong class="text-black">$${total+15}</strong>
                  </div>
                </div>
